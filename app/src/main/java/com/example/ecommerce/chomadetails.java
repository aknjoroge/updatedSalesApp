...
public class chomadetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chomadetails);
        ...
        tocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity.equals("none")){
                    ...
                    final Snackbar snackbar= Snackbar.make(findViewById(R.id.frydetailslayout), "SELECT A QUANTITY TO PURCHASE", Snackbar.LENGTH_LONG)
                            .setAction("Action", null);
                    View snackbarView = snackbar.getView();
                    FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) snackbarView.getLayoutParams();
                    params.topMargin =50;
                ...
                fStore.collection("CartList").document("all").collection("peruser").document(userid).collection("orders")
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        fStore.collection("CartList").document("individual").collection("items")
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                loadBar.hide();
                                Toast.makeText(chomadetails.this, "Added to cart Successfully", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(chomadetails.this,chomahome.class);
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(chomadetails.this, "Cart list item failed to upload", Toast.LENGTH_LONG).show();
                            }
                        });
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(chomadetails.this, "error updating Data one"+e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void getprices() {
        ...
        final DocumentReference documentReference =  fStore.collection("Products")
                .document("allforchoma").collection("Choma").document(pid);;
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                half.setText("3500g: "+priceone +"/=");
                full.setText("500g: "+pricetwo +"/=");
    ...
    public void uploaddate() {
        ...
        final DocumentReference documentReference =  fStore.collection("Products").document("allforchoma").collection("Choma").document(pid);
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
        ...
        FirestoreRecyclerAdapter<forcategory,categoryviewholder> adapter= new FirestoreRecyclerAdapter<forcategory, categoryviewholder>(options) {
            ...
            protected void onBindViewHolder(@NonNull categoryviewholder holder, int position, @NonNull final forcategory model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(chomadetails.this,home.class);
    ...
    public void callone(){
        android.app.AlertDialog dialog = new AlertDialog.Builder(this,R.style.AlertDialogStyle)
                ...
                .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(chomadetails.this, "Call Cancelled", Toast.LENGTH_SHORT).show();
                    }
                })
                .show();
    }
