...
public class frydetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frydetails);
            ...
            public void onClick(View v) {
                ...
                fStore.collection("CartList").document("all").collection("peruser").document(userid).collection("orders")
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        fStore.collection("CartList").document("individual").collection("items")
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                loadBar.hide();
                                Toast.makeText(frydetails.this, "Added to cart Successfully", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(frydetails.this,fryhome.class);
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(frydetails.this, "Cart list item failed to upload", Toast.LENGTH_LONG).show();
                            }
                        });
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(frydetails.this, "error updating Data one"+e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void getprices() {
        ...
        final DocumentReference documentReference =  fStore.collection("Products")
                .document("allforpork").collection("Pork_Fry").document(pid);;
    ...
    public void uploaddate() {
        ...
        final DocumentReference documentReference =  fStore.collection("Products").document("allforpork").collection("Pork_Fry").document(pid);
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
        ...
        FirestoreRecyclerAdapter<forcategory,categoryviewholder> adapter= new FirestoreRecyclerAdapter<forcategory, categoryviewholder>(options) {
            ...
            protected void onBindViewHolder(@NonNull categoryviewholder holder, int position, @NonNull final forcategory model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(frydetails.this,home.class);
    ...
    public void callone(){
        android.app.AlertDialog dialog = new AlertDialog.Builder(this,R.style.AlertDialogStyle)
                ...
                .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(frydetails.this, "Call Cancelled", Toast.LENGTH_SHORT).show();
                    }
                })
                .show();
    }
