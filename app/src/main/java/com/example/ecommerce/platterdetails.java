...
public class platterdetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_platterdetails);
        ...
        tocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (generalstate.equals("present")){
                    ...
                    final Snackbar snackbar= Snackbar.make(findViewById(R.id.frydetailslayout), "YOU HAVE A " +
                ...
                fStore.collection("CartList").document("all").collection("peruser").document(userid).collection("orders")
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        fStore.collection("CartList").document("individual").collection("items")
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(platterdetails.this, "Cart list item failed to upload", Toast.LENGTH_LONG).show();
                            }
                        });
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(platterdetails.this, "error updating Data one"+e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void getitems() {
        ...
        FirestoreRecyclerOptions<platterfordetailitem> options = new FirestoreRecyclerOptions.Builder<platterfordetailitem>()
                .setQuery(fStore.collection("Products").document("all")
                        .collection("Platters").document(pid).collection("items"),platterfordetailitem.class).build();
        FirestoreRecyclerAdapter<platterfordetailitem,platterdetailitemviewholder> adapter= new FirestoreRecyclerAdapter<platterfordetailitem, platterdetailitemviewholder>(options) {
            @Override
            ...
            @NonNull
            @Override
            public platterdetailitemviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void uploaddate() {
        ...
        final DocumentReference documentReference =  fStore.collection("Products")
                .document("all").collection("Platters").document(pid);
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
        ...
        FirestoreRecyclerAdapter<forcategory,categoryviewholder> adapter= new FirestoreRecyclerAdapter<forcategory, categoryviewholder>(options) {
            ...
            protected void onBindViewHolder(@NonNull categoryviewholder holder, int position, @NonNull final forcategory model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(platterdetails.this,home.class);
    ...
    public void callone(){
        android.app.AlertDialog dialog = new AlertDialog.Builder(this,R.style.AlertDialogStyle)
                ...
                .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(platterdetails.this, "Call Cancelled", Toast.LENGTH_SHORT).show();
                    }
                })
                .show();
    }
